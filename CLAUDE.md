...
Persistent instructions for Claude Code. Read MIGRATION_BRIEF.md for full context before structural work.
...
- Keep modules in the layout defined in MIGRATION_BRIEF.md §3; one responsibility per file.
