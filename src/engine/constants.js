...
export const SPAWN = { x:1958, y:2304 };  // neighborhood-local (doghouse road, south of HY2)
export const NAPS  = [ {x:920,y:1176}, {x:440,y:616}, {x:2040,y:1256} ]; // neighborhood-local
